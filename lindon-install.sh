...
# need to force-restart a running PipeWire session mid-install --
# doing that tears down whatever's already connected to it (caed
# included) for no reason, when the config will simply take effect
# cleanly on the next login anyway.
# ---------------------------------------------------------------------
